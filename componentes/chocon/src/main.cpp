...
/** \mainpage RoboComp::chocon
 *
 * \section intro_sec Introduction
 *
 * The chocon component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/chocon --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class chocon : public RoboComp::Application
{
public:
	chocon (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
