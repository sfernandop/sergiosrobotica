...
/** \mainpage RoboComp::choconFinal
 *
 * \section intro_sec Introduction
 *
 * The choconFinal component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/choconFinal --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class choconFinal : public RoboComp::Application
{
public:
	choconFinal (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::choconFinal::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
