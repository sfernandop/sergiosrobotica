...
/** \mainpage RoboComp::planificador
 *
 * \section intro_sec Introduction
 *
 * The planificador component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/planificador --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class planificador : public RoboComp::Application
{
public:
	planificador (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::planificador::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
